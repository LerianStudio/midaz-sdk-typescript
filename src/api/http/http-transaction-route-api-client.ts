  ...
  implements TransactionRouteApiClient
{
  ...
  async getTransactionRoute(
    ...
    const url = this.urlBuilder.buildTransactionRouteUrl(
      organizationId,
      ledgerId,
      transactionRouteId
    );

    return this.getRequest<TransactionRoute>('getTransactionRoute', url);
  }
  ...
  async createTransactionRoute(
    ...
    return this.postRequest<TransactionRoute>('createTransactionRoute', url, input);
  }
  ...
  async updateTransactionRoute(
    ...
    return this.patchRequest<TransactionRoute>('updateTransactionRoute', url, input);
  }
  ...
  async deleteTransactionRoute(
    ...
    return this.deleteRequest('deleteTransactionRoute', url);
  }
}
