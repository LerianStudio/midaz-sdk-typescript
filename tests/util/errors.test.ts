...
describe('Error Utilities', () => {
  ...
  describe('Error Factory Functions', () => {
    ...
    it('should create a cancellation error', () => {
      const error = newCancellationError('Operation cancelled', { operation: 'processTransaction' });
    ...
    it('should create an internal error', () => {
      const error = newInternalError('Internal error occurred', { operation: 'processTransaction' });
  ...
  describe('Error Utility Functions', () => {
    ...
    it('should categorize transaction error', () => {
      const error = new MidazError({ category: ErrorCategory.UNPROCESSABLE, code: ErrorCode.INSUFFICIENT_BALANCE, message: 'Insufficient balance for transaction' });
  ...
  describe('HTTP Response Error Mapping', () => {
    it('should map 400 status code to validation error', () => {
      const error = errorFromHttpResponse(400, {
    ...
    it('should map 401 status code to authentication error', () => {
      const error = errorFromHttpResponse(401, {
    ...
    it('should map 403 status code to authorization error', () => {
      const error = errorFromHttpResponse(403, {
    ...
    it('should map 404 status code to not found error', () => {
      const error = errorFromHttpResponse(404, {
        message: 'Resource not found',
        resource: 'account',
        resourceId: 'acc_123'
      }, 'GET', '/accounts/acc_123');
    ...
    it('should map 409 status code to conflict error', () => {
      const error = errorFromHttpResponse(409, {
    ...
    it('should map 429 status code to rate limit exceeded error', () => {
      const error = errorFromHttpResponse(429, {
    ...
    it('should map 500 status code to internal error', () => {
      const error = errorFromHttpResponse(500, {
    ...
    it('should map 504 status code to timeout error', () => {
      const error = errorFromHttpResponse(504, {
    ...
    it('should map unknown status code to generic error', () => {
      const error = errorFromHttpResponse(599, {
