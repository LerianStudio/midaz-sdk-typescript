...
describe('Asset Rate Model and Helper Functions', () => {
  ...
  it('shouldCreateAssetRateInputWithStringDates', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, effectiveAt, expirationAt);
  ...
  it('shouldCreateAssetRateInputWithDateObjects', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, effectiveDate, expirationDate);
  ...
  it('shouldCreateAssetRateInputWithMixedDateTypes', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, effectiveDate, expirationAt);
  ...
  it('shouldCreateAssetRateInputWithReverseMixedDateTypes', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, effectiveAt, expirationDate);
  ...
  it('shouldCreateAssetRateWithSameDayEffectiveAndExpiration', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, sameDay, sameDayEnd);
  ...
  it('shouldCreateAssetRateWithLongTermExpiration', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, effectiveAt, farFuture);
  ...
  it('shouldCreateAssetRateWithCurrentDateTime', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, now, tomorrow);
  ...
  it('shouldCreateAssetRateWithNonStandardDateFormat', () => {
    ...
    const input = createUpdateAssetRateInput('USD', 'EUR', 0.92, date, '2023-01-02T00:00:00Z');
