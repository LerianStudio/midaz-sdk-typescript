...
describe('Asset Model and Helper Functions', () => {
    ...
    it('shouldCreateAssetInputWithRequiredFields', () => {
        const input = createAssetBuilder('US Dollar', 'USD')
            .build();
    ...
    it('shouldHandleSpecialCharactersInAssetName', () => {
        ...
        const input = createAssetBuilder(specialName, 'SPECIAL')
            .build();
    ...
    it('shouldHandleComplexMetadataObjects', () => {
        const input = createAssetBuilder('Complex Asset', 'COMPLEX')
            .build();
    ...
    it('shouldHandleLongAssetNames', () => {
        ...
        const input = createAssetBuilder(longName, 'LONG')
            .build();
    ...
    it('shouldHandleLongAssetCodes', () => {
        ...
        const input = createAssetBuilder('Long Code Asset', longCode)
            .build();
    ...
    it('shouldHandleLargeMetadataObjects', () => {
        const input = createAssetBuilder('Large Metadata Asset', 'LARGE')
            .build();
    ...
    it('shouldHandleNullMetadataValues', () => {
        const input = createAssetBuilder('Null Metadata Asset', 'NULL')
            .build();
    ...
    it('shouldHandleEmptyStringsForRequiredFields', () => {
        const input = createAssetBuilder('', '')
            .build();
    ...
    it('shouldSetStatusToDifferentValues', () => {
        ...
        const input = createAssetBuilder('Status Test', 'STATUS')
            .build();
    ...
    it('shouldOverrideExistingValues', () => {
        // Note: In the new builder pattern, status is set in the model but not included in the output
        const input = createAssetBuilderWithType('Original Name', 'CODE', 'ORIGINAL_TYPE')
            .build();
        ...
        const overriddenStatusBuilder = createAssetBuilderWithType('Original Name', 'CODE', 'ORIGINAL_TYPE');
    ...
    it('shouldSetMetadataOnUpdateInput', () => {
        ...
        const result = createUpdateAssetBuilder()
            .withMetadata(metadata)
            .build();
