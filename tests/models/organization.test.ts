...
describe('Organization Model and Helper Functions', () => {
  ...
  it('shouldCreateOrganizationInputWithRequiredFields', () => {
    const input = createOrganizationBuilder('Acme Corporation', '123456789', 'Acme').build();
  ...
  it('shouldCreateOrganizationInputWithStatus', () => {
    const input = createOrganizationBuilder('Acme Corporation', '123456789', 'Acme')
  ...
  it('shouldCreateOrganizationInputWithAllFields', () => {
    ...
    const result = createOrganizationBuilder('Acme Corporation', '123456789', 'Acme')
      .withStatus(StatusCode.ACTIVE)
      .withAddress(address)
      .withMetadata(metadata)
      .withParentOrganizationId(parentId)
  ...
  it('shouldSetStatusOnUpdateInput', () => {
    ...
    const updateInput = createUpdateOrganizationBuilder().withStatus(StatusCode.INACTIVE).build();
  ...
  it('shouldSetAddressOnUpdateInput', () => {
    ...
    const updateInput = createUpdateOrganizationBuilder().withAddress(address).build();
  ...
  it('shouldSetMetadataOnUpdateInput', () => {
    ...
    const updateInput = createUpdateOrganizationBuilder().withMetadata(metadata).build();
  ...
  it('shouldCreateMinimalOrganization', () => {
    const input = createOrganizationBuilder('Minimal Org', '12345', 'Min').build();
  ...
  it('shouldHandleSpecialCharactersInOrganizationNames', () => {
    ...
    const input = createOrganizationBuilder(specialName, '12345', 'Special').build();
