...
describe('AccountsServiceImpl', () => {
  ...
  describe('listAccounts', () => {
    it('should list accounts successfully', async () => {
      ...
      // Verify
      expect(mockAccountApiClient.listAccounts).toHaveBeenCalledWith(orgId, ledgerId, undefined);
    ...
    it('should apply list options when provided', async () => {
      ...
      // Verify
      expect(mockAccountApiClient.listAccounts).toHaveBeenCalledWith(orgId, ledgerId, listOptions);
      expect(result).toEqual(mockAccountsList);
    });

    it('should handle empty orgId', async () => {
      // Setup
      mockAccountApiClient.listAccounts.mockRejectedValueOnce(
        new Error('Organization ID is required')
      );

      // Execute & Verify
      await expect(accountsService.listAccounts('', ledgerId)).rejects.toThrow(
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.listAccounts(orgId, '')).rejects.toThrow(
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.listAccounts(orgId, ledgerId)).rejects.toThrow('API Error');
    });
  });
  ...
  describe('getAccount', () => {
    it('should get an account by ID successfully', async () => {
      ...
      // Verify
      expect(mockAccountApiClient.getAccount).toHaveBeenCalledWith(orgId, ledgerId, accountId);
      expect(result).toEqual(mockAccount);
    });

    it('should handle empty orgId', async () => {
      // Setup
      mockAccountApiClient.getAccount.mockRejectedValueOnce(
        new Error('Organization ID is required')
      );

      // Execute & Verify
      await expect(accountsService.getAccount('', ledgerId, accountId)).rejects.toThrow(
        'Organization ID is required'
      );
    });
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.getAccount(orgId, '', accountId)).rejects.toThrow(
        'Ledger ID is required'
      );
    });
    ...
    it('should handle empty accountId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.getAccount(orgId, ledgerId, '')).rejects.toThrow(
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.getAccount(orgId, ledgerId, accountId)).rejects.toThrow(
        'API Error'
      );
    });
  });
  ...
  describe('createAccount', () => {
    it('should create an account successfully', async () => {
      ...
      // Verify
      expect(mockAccountApiClient.createAccount).toHaveBeenCalledWith(orgId, ledgerId, createInput);
      expect(result).toEqual(mockAccount);
    });
    ...
    it('should handle empty orgId', async () => {
      ...
      mockAccountApiClient.createAccount.mockRejectedValueOnce(
        new Error('Organization ID is required')
      );

      // Execute & Verify
      await expect(accountsService.createAccount('', ledgerId, createInput)).rejects.toThrow(
        'Organization ID is required'
      );
    });
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.createAccount(orgId, '', createInput)).rejects.toThrow(
        'Ledger ID is required'
      );
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.createAccount(orgId, ledgerId, createInput)).rejects.toThrow(
        'API Error'
      );
    });
  });
  ...
  describe('updateAccount', () => {
    ...
    it('should handle empty orgId', async () => {
      ...
      mockAccountApiClient.updateAccount.mockRejectedValueOnce(
        new Error('Organization ID is required')
      );

      // Execute & Verify
      await expect(
        accountsService.updateAccount('', ledgerId, accountId, updateInput)
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(
        accountsService.updateAccount(orgId, '', accountId, updateInput)
    ...
    it('should handle empty accountId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.updateAccount(orgId, ledgerId, '', updateInput)).rejects.toThrow(
        'Account ID is required'
      );
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(
        accountsService.updateAccount(orgId, ledgerId, accountId, updateInput)
  ...
  describe('deleteAccount', () => {
    it('should delete an account successfully', async () => {
      ...
      // Verify
      expect(mockAccountApiClient.deleteAccount).toHaveBeenCalledWith(orgId, ledgerId, accountId);
    });

    it('should handle empty orgId', async () => {
      // Setup
      mockAccountApiClient.deleteAccount.mockRejectedValueOnce(
        new Error('Organization ID is required')
      );

      // Execute & Verify
      await expect(accountsService.deleteAccount('', ledgerId, accountId)).rejects.toThrow(
        'Organization ID is required'
      );
    });
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.deleteAccount(orgId, '', accountId)).rejects.toThrow(
        'Ledger ID is required'
      );
    });
    ...
    it('should handle empty accountId', async () => {
      ...
      // Execute & Verify
      await expect(accountsService.deleteAccount(orgId, ledgerId, '')).rejects.toThrow(
        'Account ID is required'
      );
    });
