...
describe('AssetsServiceImpl', () => {
  ...
  describe('listAssets', () => {
    it('should list assets successfully', async () => {
      ...
      // Verify
      expect(mockAssetApiClient.listAssets).toHaveBeenCalledWith(orgId, ledgerId, undefined);
    ...
    it('should apply list options when provided', async () => {
      ...
      // Verify
      expect(mockAssetApiClient.listAssets).toHaveBeenCalledWith(orgId, ledgerId, listOptions);
      expect(result).toEqual(mockAssetsList);
    });
    ...
    it('should delegate validation to the API client', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.listAssets('', ledgerId)).rejects.toThrow(
        'Organization ID is required'
      );
      expect(mockAssetApiClient.listAssets).toHaveBeenCalledWith('', ledgerId, undefined);
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.listAssets(orgId, ledgerId)).rejects.toThrow('API Error');
    });
  });
  ...
  describe('getAsset', () => {
    it('should get an asset by ID successfully', async () => {
      ...
      // Verify
      expect(mockAssetApiClient.getAsset).toHaveBeenCalledWith(orgId, ledgerId, assetId);
    ...
    it('should delegate validation to the API client', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.getAsset('', ledgerId, assetId)).rejects.toThrow(
        'Validation failed'
      );
      expect(mockAssetApiClient.getAsset).toHaveBeenCalledWith('', ledgerId, assetId);
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.getAsset(orgId, ledgerId, assetId)).rejects.toThrow('API Error');
    });
  });
  ...
  describe('createAsset', () => {
    it('should create an asset successfully', async () => {
      ...
      // Verify
      expect(mockAssetApiClient.createAsset).toHaveBeenCalledWith(orgId, ledgerId, createInput);
      expect(result).toEqual(mockAsset);
    });
    ...
    it('should delegate validation to the API client', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.createAsset('', ledgerId, createInput)).rejects.toThrow(
        'Validation failed'
      );
      expect(mockAssetApiClient.createAsset).toHaveBeenCalledWith('', ledgerId, createInput);
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.createAsset(orgId, ledgerId, createInput)).rejects.toThrow(
        'API Error'
      );
    });
  });
  ...
  describe('updateAsset', () => {
    ...
    it('should delegate validation to the API client', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.updateAsset('', ledgerId, assetId, updateInput)).rejects.toThrow(
        'Validation failed'
      );
      expect(mockAssetApiClient.updateAsset).toHaveBeenCalledWith(
        '',
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(
        assetsService.updateAsset(orgId, ledgerId, assetId, updateInput)
  ...
  describe('deleteAsset', () => {
    it('should delete an asset successfully', async () => {
      ...
      // Verify
      expect(mockAssetApiClient.deleteAsset).toHaveBeenCalledWith(orgId, ledgerId, assetId);
    });
    ...
    it('should delegate validation to the API client', async () => {
      ...
      // Execute & Verify
      await expect(assetsService.deleteAsset('', ledgerId, assetId)).rejects.toThrow(
        'Validation failed'
      );
      expect(mockAssetApiClient.deleteAsset).toHaveBeenCalledWith('', ledgerId, assetId);
    });
