...
describe('LedgersServiceImpl', () => {
  ...
  describe('listLedgers', () => {
    it('should list ledgers successfully', async () => {
      ...
      // Verify
      expect(mockLedgerApiClient.listLedgers).toHaveBeenCalledWith(
        orgId,
        undefined
      );
    ...
    it('should delegate validation to the API client', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.listLedgers(''))
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.listLedgers(orgId))
  ...
  describe('getLedger', () => {
    it('should get a ledger by ID successfully', async () => {
      ...
      // Verify
      expect(mockLedgerApiClient.getLedger).toHaveBeenCalledWith(
        orgId,
        ledgerId
      );
    ...
    it('should delegate validation to the API client for missing orgId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.getLedger('', ledgerId))
        .rejects.toThrow('Organization ID is required');
    ...
    it('should delegate validation to the API client for missing ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.getLedger(orgId, ''))
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.getLedger(orgId, ledgerId))
        .rejects.toThrow('API Error');
    });
  });
  ...
  describe('createLedger', () => {
    it('should create a ledger successfully', async () => {
      ...
      // Verify
      expect(mockLedgerApiClient.createLedger).toHaveBeenCalledWith(
        orgId,
        createInput
      );
      expect(result).toEqual(mockLedger);
    ...
    it('should delegate validation to the API client for missing orgId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.createLedger('', createInput))
        .rejects.toThrow('Organization ID is required');
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.createLedger(orgId, createInput))
        .rejects.toThrow('API Error');
    });
  });
  ...
  describe('updateLedger', () => {
    it('should update a ledger successfully', async () => {
      ...
      // Verify
      expect(mockLedgerApiClient.updateLedger).toHaveBeenCalledWith(
        orgId,
        ledgerId,
        updateInput
      );
    ...
    it('should delegate validation to the API client for missing orgId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.updateLedger('', ledgerId, updateInput))
        .rejects.toThrow('Organization ID is required');
    ...
    it('should delegate validation to the API client for missing ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.updateLedger(orgId, '', updateInput))
        .rejects.toThrow('Ledger ID is required');
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.updateLedger(orgId, ledgerId, updateInput))
        .rejects.toThrow('API Error');
    });
  });
  ...
  describe('deleteLedger', () => {
    it('should delete a ledger successfully', async () => {
      ...
      // Verify
      expect(mockLedgerApiClient.deleteLedger).toHaveBeenCalledWith(
        orgId,
        ledgerId
      );
    });
    ...
    it('should delegate validation to the API client for missing orgId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.deleteLedger('', ledgerId))
        .rejects.toThrow('Organization ID is required');
    ...
    it('should delegate validation to the API client for missing ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.deleteLedger(orgId, ''))
        .rejects.toThrow('Ledger ID is required');
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(ledgersService.deleteLedger(orgId, ledgerId))
        .rejects.toThrow('API Error');
    });
  });
});
