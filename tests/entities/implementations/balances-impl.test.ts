...
describe('BalancesServiceImpl', () => {
  ...
  describe('listBalances', () => {
    it('should list balances successfully', async () => {
      ...
      // Verify
      expect(mockBalanceApiClient.listBalances).toHaveBeenCalledWith(
        orgId,
        ledgerId,
        undefined
      );
    ...
    it('should handle empty orgId', async () => {
      // Setup
      mockBalanceApiClient.listBalances.mockRejectedValueOnce(new Error('Organization ID is required'));
      
      // Execute & Verify
      await expect(balancesService.listBalances('', ledgerId))
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.listBalances(orgId, ''))
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.listBalances(orgId, ledgerId))
  ...
  describe('listAccountBalances', () => {
    ...
    it('should apply list options when provided', async () => {
      ...
      // Execute
      const result = await balancesService.listAccountBalances(orgId, ledgerId, accountId, listOptions);
    ...
    it('should handle empty orgId', async () => {
      // Setup
      mockBalanceApiClient.listAccountBalances.mockRejectedValueOnce(new Error('Organization ID is required'));
      
      // Execute & Verify
      await expect(balancesService.listAccountBalances('', ledgerId, accountId))
        .rejects.toThrow('Organization ID is required');
    });
    
    it('should handle empty ledgerId', async () => {
      // Setup
      mockBalanceApiClient.listAccountBalances.mockRejectedValueOnce(new Error('Ledger ID is required'));
      
      // Execute & Verify
      await expect(balancesService.listAccountBalances(orgId, '', accountId))
        .rejects.toThrow('Ledger ID is required');
    });
    
    it('should handle empty accountId', async () => {
      // Setup
      mockBalanceApiClient.listAccountBalances.mockRejectedValueOnce(new Error('Account ID is required'));
      
      // Execute & Verify
      await expect(balancesService.listAccountBalances(orgId, ledgerId, ''))
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.listAccountBalances(orgId, ledgerId, accountId))
        .rejects.toThrow('API Error');
    });
  });
  ...
  describe('getBalance', () => {
    it('should get a balance by ID successfully', async () => {
      ...
      // Verify
      expect(mockBalanceApiClient.getBalance).toHaveBeenCalledWith(
        orgId,
        ledgerId,
        balanceId
      );
    ...
    it('should handle empty orgId', async () => {
      // Setup
      mockBalanceApiClient.getBalance.mockRejectedValueOnce(new Error('Organization ID is required'));
      
      // Execute & Verify
      await expect(balancesService.getBalance('', ledgerId, balanceId))
        .rejects.toThrow('Organization ID is required');
    });
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.getBalance(orgId, '', balanceId))
        .rejects.toThrow('Ledger ID is required');
    });
    ...
    it('should handle empty balanceId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.getBalance(orgId, ledgerId, ''))
        .rejects.toThrow('Balance ID is required');
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.getBalance(orgId, ledgerId, balanceId))
        .rejects.toThrow('API Error');
    });
  });
  ...
  describe('updateBalance', () => {
    ...
    it('should handle empty orgId', async () => {
      ...
      mockBalanceApiClient.updateBalance.mockRejectedValueOnce(new Error('Organization ID is required'));
      
      // Execute & Verify
      await expect(balancesService.updateBalance('', ledgerId, balanceId, updateInput))
        .rejects.toThrow('Organization ID is required');
    });
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.updateBalance(orgId, '', balanceId, updateInput))
        .rejects.toThrow('Ledger ID is required');
    });
    ...
    it('should handle empty balanceId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.updateBalance(orgId, ledgerId, '', updateInput))
        .rejects.toThrow('Balance ID is required');
    });
    ...
    it('should handle validation errors', async () => {
      ...
      mockBalanceApiClient.updateBalance.mockRejectedValueOnce(new ValidationError('Invalid input'));
      
      // Execute & Verify
      await expect(balancesService.updateBalance(orgId, ledgerId, balanceId, invalidInput))
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.updateBalance(orgId, ledgerId, balanceId, updateInput))
        .rejects.toThrow('API Error');
    });
  });
  ...
  describe('deleteBalance', () => {
    it('should delete a balance successfully', async () => {
      ...
      // Verify
      expect(mockBalanceApiClient.deleteBalance).toHaveBeenCalledWith(
        orgId,
        ledgerId,
        balanceId
      );
    ...
    it('should handle empty orgId', async () => {
      // Setup
      mockBalanceApiClient.deleteBalance.mockRejectedValueOnce(new Error('Organization ID is required'));
      
      // Execute & Verify
      await expect(balancesService.deleteBalance('', ledgerId, balanceId))
        .rejects.toThrow('Organization ID is required');
    });
    ...
    it('should handle empty ledgerId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.deleteBalance(orgId, '', balanceId))
        .rejects.toThrow('Ledger ID is required');
    });
    ...
    it('should handle empty balanceId', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.deleteBalance(orgId, ledgerId, ''))
        .rejects.toThrow('Balance ID is required');
    });
    ...
    it('should handle API errors', async () => {
      ...
      // Execute & Verify
      await expect(balancesService.deleteBalance(orgId, ledgerId, balanceId))
        .rejects.toThrow('API Error');
    });
  });
});
